...
class FontsControllerTest < ActionController::TestCase
  ...
  test "should create font" do
    assert_difference('Font.count') do
      post :create, font: { optimalsize: @font.optimalsize, typeface_id: @font.typeface_id, weightname: @font.weightname }
    end
  ...
  test "should update font" do
    patch :update, id: @font, font: { optimalsize: @font.optimalsize, typeface_id: @font.typeface_id, weightname: @font.weightname }
    assert_redirected_to font_path(assigns(:font))
  end
